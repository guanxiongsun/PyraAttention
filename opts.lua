...
function M.parse(arg)
   ...
   cmd:option('-resume',       'checkpoints/mpii/two-hg-stack2-fusion', 'Resume from the latest checkpoint in this directory')
   ...
   cmd:option('-w_1',          1,          'w_1 is the weight for heatmap loss.')
   cmd:option('-w_2',          0.005,      'w_1 is the weight for heatmap loss.')
   ---------- Model options ----------------------------------
